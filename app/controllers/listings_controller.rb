...
class ListingsController < ApplicationController
  ...
  def show
    ...
    form_path = @current_user ? person_transactions_path(person_id: @current_user.id, listing_id: @listing.id) : new_transaction_path(listing_id: @listing.id)
    form_method = @current_user ? 'POST' : 'GET'
